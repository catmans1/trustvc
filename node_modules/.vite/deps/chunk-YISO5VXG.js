...
function proxy(value) {
  ...
  var version = state(0);
  var stack2 = true_default2 && tracing_mode_flag ? get_error("created at") : null;
  ...
  return new Proxy(
    ...
    value,
    {
      defineProperty(_, prop2, descriptor) {
        ...
        if (s === void 0) {
          with_parent(() => {
            ...
            if (true_default2 && typeof prop2 === "string") {
      ...
      get(target, prop2, receiver) {
        ...
        if (true_default2 && prop2 === PROXY_PATH_SYMBOL) {
          return update_path;
        }
        var s = sources.get(prop2);
...
function handle_error(error) {
  ...
  if (true_default2 && error instanceof Error && !adjustments.has(error)) {
    adjustments.set(error, get_adjustments(error, effect2));
  }
  if ((effect2.f & REACTION_RAN) === 0 && (effect2.f & EFFECT) === 0) {
    if (true_default2 && !effect2.parent && error instanceof Error) {
...
function invoke_error_boundary(error, effect2) {
  ...
  if (true_default2 && error instanceof Error) {
    apply_adjustments(error);
  }
  throw error;
}
...
var flush_count = 0;
var source_stacks = true_default2 ? /* @__PURE__ */ new Set() : null;
var uid = 1;
...
var _Batch = class _Batch {
  ...
  flush() {
    var source_stacks2 = true_default2 ? /* @__PURE__ */ new Set() : null;
    try {
      is_processing = true;
      current_batch = this;
...
function source(v, stack2) {
  ...
  if (true_default2 && tracing_mode_flag) {
...
function mark_reactions(signal, status, updated_during_traversal) {
  ...
  for (var i = 0; i < length; i++) {
    ...
    if (true_default2 && (flags2 & EAGER_EFFECT) !== 0) {
...
function update_effect(effect2) {
  ...
  try {
    ...
    if (true_default2 && tracing_mode_flag && (effect2.f & DIRTY) !== 0 && effect2.deps !== null) {
...
// ../../../../../../dev/wisdomcerts/cache/src-ts-trustvc/frontend/node_modules/svelte/src/internal/client/timing.js
...
// ../../../../../../dev/wisdomcerts/cache/src-ts-trustvc/frontend/node_modules/svelte/src/internal/client/loop.js
function run_tasks() {
  const now2 = raf2.now();
  raf2.tasks.forEach((task) => {
    if (!task.c(now2)) {
      raf2.tasks.delete(task);
      task.f();
    }
  });
  if (raf2.tasks.size !== 0) {
    raf2.tick(run_tasks);
  }
}
function loop2(callback) {
  ...
  return {
    promise: new Promise((fulfill) => {
      raf2.tasks.add(task = { c: callback, f: fulfill });
    }),
    abort() {
      raf2.tasks.delete(task);
    }
...
//# sourceMappingURL=chunk-YISO5VXG.js.map
