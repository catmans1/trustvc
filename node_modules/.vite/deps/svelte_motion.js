...
import {
  true_default as true_default2
} from "./chunk-JZA7MQ6I.js";
import "./chunk-3TIOZA6A.js";
import {
  __privateAdd,
  __privateGet,
  __privateMethod,
...
// ../../../../../../dev/wisdomcerts/cache/src-ts-trustvc/frontend/node_modules/svelte/src/motion/utils.js
function is_date(obj) {
  return Object.prototype.toString.call(obj) === "[object Date]";
}

// ../../../../../../dev/wisdomcerts/cache/src-ts-trustvc/frontend/node_modules/svelte/src/motion/spring.js
...
var _Spring = class _Spring {
  ...
  constructor(value, options = {}) {
    ...
    __privateAdd(this, _stiffness, state2(0.15));
    __privateAdd(this, _damping, state2(0.8));
    __privateAdd(this, _precision, state2(0.01));
    ...
    __privateSet(this, _current, true_default2 ? tag2(state2(value), "Spring.current") : state2(value));
    __privateSet(this, _target, true_default2 ? tag2(state2(value), "Spring.target") : state2(value));
    ...
    if (true_default2) {
      tag2(__privateGet(this, _stiffness), "Spring.stiffness");
      tag2(__privateGet(this, _damping), "Spring.damping");
      tag2(__privateGet(this, _precision), "Spring.precision");
      tag2(__privateGet(this, _current), "Spring.current");
      tag2(__privateGet(this, _target), "Spring.target");
    }
  }
  /**
  ...
  get current() {
    return get2(__privateGet(this, _current));
  }
  get damping() {
    return get2(__privateGet(this, _damping));
  }
  set damping(v) {
    set(__privateGet(this, _damping), clamp(v, 0, 1));
  }
  get precision() {
    return get2(__privateGet(this, _precision));
  }
  set precision(v) {
    set(__privateGet(this, _precision), v);
  }
  get stiffness() {
    return get2(__privateGet(this, _stiffness));
  }
  set stiffness(v) {
    set(__privateGet(this, _stiffness), clamp(v, 0, 1));
  }
  get target() {
    return get2(__privateGet(this, _target));
  }
  set target(v) {
    this.set(v);
  }
...
// ../../../../../../dev/wisdomcerts/cache/src-ts-trustvc/frontend/node_modules/svelte/src/motion/tweened.js
...
var _Tween = class _Tween {
  ...
  constructor(value, options = {}) {
    ...
    __privateSet(this, _current2, state2(value));
    __privateSet(this, _target2, state2(value));
    __privateSet(this, _defaults, options);
    if (true_default2) {
      tag2(__privateGet(this, _current2), "Tween.current");
      tag2(__privateGet(this, _target2), "Tween.target");
    }
  }
  /**
...
// ../../../../../../dev/wisdomcerts/cache/src-ts-trustvc/frontend/node_modules/svelte/src/motion/index.js
